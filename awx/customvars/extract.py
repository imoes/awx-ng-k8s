...
def scan_project_roles(project_id: int, project_path: str, revision: str) -> dict:
    ...
    """
    from awx.customvars.models import RoleVariable, RoleScan
    ...
    for role_dir in sorted(roles_dir.iterdir()):
        ...
        try:
            ...
            log.debug("extract: %s → %d Variablen", role_name, len(extracted))
    ...
    log.info(
        "scan_project_roles project=%d rev=%s: %d Rollen, %d Variablen, %d Fehler",
        project_id,
